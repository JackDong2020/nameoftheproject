...
const Home = () => {
  ...
  const fetchNFTs = async() => {
    ...
    const api_key = "G3Q-Ah7yeAHazAZ1WlkhPKmrWSfwn-4w"
    ...
    if (!collection.length) {
      ...
      // const fetchURL = `${baseURL}?owner=0x5E00473077C622E4Af698D790b5a1670ceC5b8E9`;
...
export default Home
// 0x5E00473077C622E4Af698D790b5a1670ceC5b8E9